...
public class GetAllUsersSteps extends BaseSteps {
	...
	public void theUserSendsAGETRequestToGetAllUsersEndpointWithAsAs(String startAt, int value1, String maxResults,
			int value2) {
	...
	public void theUserSendsAGETRequestToGetAllUsersEndpointWithAsAs(String startAt, String value1, String maxResults,
			String value2) {
		parameters.put(startAt, value1);
		parameters.put(maxResults, value2);
