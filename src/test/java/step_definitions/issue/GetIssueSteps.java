...
public class GetIssueSteps extends BaseSteps {
	...
	public void theSelfAndAvatarURLsShouldntBeEmpty() {
		...
		Assertions.assertThat(response.jsonPath().getString("fields.project.key"))
			.isEqualTo(issueReq.getFields().getProject().getKey());
		Assertions.assertThat(response.jsonPath().getString("fields.summary"))
			.isEqualTo(issueReq.getFields().getSummary());
		Assertions.assertThat(response.jsonPath().getString("fields.description.type"))
			.isEqualTo(issueReq.getFields().getDescription().getType());
		Assertions.assertThat(response.jsonPath().getInt("fields.description.version"))
			.isEqualTo(issueReq.getFields().getDescription().getVersion());
		Assertions.assertThat(response.jsonPath().getString("fields.description.content[0].type"))
			.isEqualTo(issueReq.getFields().getDescription().getContent().get(0).getType());
		Assertions.assertThat(response.jsonPath().getString("fields.description.content[0].content[0].text"))
			.isEqualTo(issueReq.getFields().getDescription().getContent().get(0).getContent().get(0).getText());
		Assertions.assertThat(response.jsonPath().getString("fields.description.content[0].content[0].type"))
			.isEqualTo(issueReq.getFields().getDescription().getContent().get(0).getContent().get(0).getType());
